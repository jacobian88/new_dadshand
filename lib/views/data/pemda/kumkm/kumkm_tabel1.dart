...
class KumkmTabel1 extends StatelessWidget {
  const KumkmTabel1({Key? key}) : super(key: key);
                ...
                children: [
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        '\nJumlah Koperasi Aktif Menurut Kecamatan di Kabupaten Kepulauan Aru, 2019-2022\n',
                        style: TextStyle(
                          ...
                          child: DataTable(
                            ...
                            rows: [
                              ...
                              DataRow(cells: [
                                ...
                                DataCell(Center(child: Text('109'))),
                                DataCell(Center(child: Text('109'))),
