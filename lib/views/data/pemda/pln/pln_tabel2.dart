...
class PlnTabel2 extends StatelessWidget {
  const PlnTabel2({Key? key}) : super(key: key);
                ...
                children: [
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        '\nJumlah Pelanggan Listrik Menurut Kecamatan di Kabupaten Kepulauan Aru,\n2018-2022\n',
                        style: TextStyle(
                          ...
                          child: DataTable(
                            ...
                            rows: [
                              DataRow(cells: [
                                ...
                                DataCell(Center(child: Text('8.886'))),
                                DataCell(Center(child: Text('9.540'))),
                                DataCell(Center(child: Text('10.153'))),
                                DataCell(Center(child: Text('10.874'))),
                                DataCell(Center(child: Text('12.024'))),
                              ]),
                              DataRow(cells: [
                              ...
                              DataRow(cells: [
                                ...
                                DataCell(Center(child: Text('555'))),
                                DataCell(Center(child: Text('555'))),
                                DataCell(Center(child: Text('670'))),
                                DataCell(Center(child: Text('670'))),
                                DataCell(Center(child: Text('670'))),
                              ]),
                              DataRow(cells: [
